# Deterministic seed bundle v002
...
QP-1's symbolic `<pageSize>` is repaired with deterministic integer limit `10`; related deterministic query placeholder defaults are `topK=5` and `numCandidates=20`.
