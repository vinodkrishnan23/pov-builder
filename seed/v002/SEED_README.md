...
This replacement bundle repairs the JavaScript syntax issue in `v001`. It recreates the seven POC collections and inserts deterministic data using Node.js 20 and the official MongoDB driver. ObjectIds are derived from SHA-256 hashes with seed `42`; dates and all other values are fixed by collection and row index.
